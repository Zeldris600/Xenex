      ...
      <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
        ...
        <div className="grid gap-8 row-gap-0 lg:grid-cols-3">
          <div className="relative text-center">
            ...
            <h6 className="mb-2 text-4xl font-extrabold">Step 1</h6>
          ...
          <div className="relative text-center">
            ...
            <h6 className="mb-2 text-4xl font-extrabold">Step 2</h6>
            <p className="max-w-md mb-3 text-xl text-gray-900 sm:mx-auto">
          ...
          <div className="relative text-center">
            ...
            <h6 className="mb-2 text-4xl font-extrabold">Step 3</h6>
            <p className="max-w-md mb-3 text-xl text-gray-900 sm:mx-auto">
