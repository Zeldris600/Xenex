...
import illustration from '../assets/img/undraw_faq_re_31cw.svg'

const FAQ = () => {
  return (
    <div className='grid md:grid-cols-2 mb-4'>
      <div className='container  border-2 mx-auto ml-4 w-full p-4 shadow-lg font-sans text-gray-800 sm:px-20 md:max-w-screen-lg lg:py-24'>
  <img src={illustration} alt="" className='object-cover' />
  
</div >
<div class=" mx-auto w-full py-16 px-5 font-sans text-gray-800 sm:px-20 md:max-w-screen-lg lg:py-24">
