...
<div class="flex w-screen flex-wrap text-slate-800 mt-7">
  ...
  <div class="relative hidden h-screen select-none bg-blue-600 bg-gradient-to-br md:block md:w-1/2">
    <div class="py-16 px-8 text-white xl:w-[40rem]">
      <span class="rounded-full bg-white px-3 py-1 font-medium text-blue-600">One Stop Shop for Electronics</span>
      <p class="my-6 text-3xl font-semibold leading-10">Buy from the comfort <span class="abg-white whitespace-nowrap py-2 text-cyan-300">of Your Home</span>.</p>
